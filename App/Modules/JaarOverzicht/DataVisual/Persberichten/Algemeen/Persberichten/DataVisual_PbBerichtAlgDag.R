...
ToAppend <- list(
  dag.plot.aantal = reactive(berichten.plot()$Aantal),
  dag.plot.procent = reactive(berichten.plot()$Procent),
  dag.tabel =  reactive(berichten.tabel()), 
  dag.uitleg = reactive(input$uitleg))
