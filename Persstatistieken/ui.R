            ...
            tabItem(
              ...
              fluidRow(
                tabBox(
                  ...
                  bericht.beleid.maandOutput("bericht.beleid.maand.plot.economie", plottitle = "Persberichten: Maand per beleid (Economie)")
                ),
                tabBox(
                  width = 6,
                  title = "Gouverneur",
                  ...
                  bericht.beleid.maandOutput("bericht.beleid.maand.plot.gouverneur", plottitle = "Persberichten: Maand per beleid (Gouverneur)")
                ),
                tabBox(
                  width = 6,
                  title = "Leefmilieu",
                  ...
                  bericht.beleid.maandOutput("bericht.beleid.maand.plot.leefmilieu", plottitle = "Persberichten: Maand per beleid (Leefmilieu)")
                ),
                tabBox(
                  width = 6,
                  title = "Mobiliteit",
                  ...
                  bericht.beleid.maandOutput("bericht.beleid.maand.plot.mobiliteit", plottitle = "Persberichten: Maand per beleid (Mobiliteit)")
                ),
                tabBox(
                  width = 6,
                  ...
                  bericht.beleid.maandOutput("bericht.beleid.maand.plot.onderwijs", plottitle = "Persberichten: Maand per beleid (Onderwijs en Educatie)")
                ),
                tabBox(
                  width = 6,
                  ...
                  bericht.beleid.maandOutput("bericht.beleid.maand.plot.provinciebestuur", plottitle = "Persberichten: Maand per beleid (Provinciebestuur)")
                ),
                tabBox(
                  width = 6,
                  title = "Ruimte",
                  ...
                  bericht.beleid.maandOutput("bericht.beleid.maand.plot.ruimte", plottitle = "Persberichten: Maand per beleid (Ruimte)")
                ),
                tabBox(
                  width = 6,
                  title = "Vrije Tijd",
                  ...
                  bericht.beleid.maandOutput("bericht.beleid.maand.plot.vrijetijd", plottitle = "Persberichten: Maand per beleid (Vrije Tijd)")
                )
              )
            ),
          # Per Beleid --------------------------------------------------------
