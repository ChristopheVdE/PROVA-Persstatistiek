            ...
            tabItem(
              ...
              fluidRow(
                tabBox(
                  ...
                  bericht.beleid.maand.plotOutput("bericht.beleid.maand.plot.economie", plottitle = "Persberichten: Maand per beleid (Economie)")
                ),
                tabBox(
                  width = 6,
                  title = "Gouverneur",
                  ...
                  bericht.beleid.maand.plotOutput("bericht.beleid.maand.plot.gouverneur", plottitle = "Persberichten: Maand per beleid (Gouverneur)")
                ),
                tabBox(
                  width = 6,
                  title = "Leefmilieu",
                  ...
                  bericht.beleid.maand.plotOutput("bericht.beleid.maand.plot.leefmilieu", plottitle = "Persberichten: Maand per beleid (Leefmilieu)")
                ),
                tabBox(
                  width = 6,
                  title = "Mobiliteit",
                  ...
                  bericht.beleid.maand.plotOutput("bericht.beleid.maand.plot.mobiliteit", plottitle = "Persberichten: Maand per beleid (Mobiliteit)")
                ),
                tabBox(
                  width = 6,
                  ...
                  bericht.beleid.maand.plotOutput("bericht.beleid.maand.plot.onderwijs", plottitle = "Persberichten: Maand per beleid (Onderwijs en Educatie)")
                ),
                tabBox(
                  width = 6,
                  ...
                  bericht.beleid.maand.plotOutput("bericht.beleid.maand.plot.provinciebestuur", plottitle = "Persberichten: Maand per beleid (Provinciebestuur)")
                ),
                tabBox(
                  width = 6,
                  title = "Ruimte",
                  ...
                  bericht.beleid.maand.plotOutput("bericht.beleid.maand.plot.ruimte", plottitle = "Persberichten: Maand per beleid (Ruimte)")
                ),
                tabBox(
                  width = 6,
                  title = "Vrije Tijd",
                  ...
                  bericht.beleid.maand.plotOutput("bericht.beleid.maand.plot.vrijetijd", plottitle = "Persberichten: Maand per beleid (Vrije Tijd)")
                )
              )
            ),
          # Per Beleid --------------------------------------------------------
            tabItem(
              ...
              fluidRow(
                tabBox(
                  ...
                  bericht.beleid.beleid.plotOutput("bericht.beleid.beleid.plot.economie", plottitle = "Persberichten: Deelbeleid per beleid (Economie)")
                ),
                tabBox(
                  width = 6,
                  ...
                  bericht.beleid.beleid.plotOutput("bericht.beleid.beleid.plot.gouverneur", plottitle = "Persberichten: Deelbeleid per beleid (Gouverneur)")
                ),
                tabBox(
                  width = 6,
                  ...
                  bericht.beleid.beleid.plotOutput("bericht.beleid.beleid.plot.leefmilieu", plottitle = "Persberichten: per deelbeleid (Leefmilieu)")
                ),  
                tabBox(
                  width = 6,
                  ...
                  bericht.beleid.beleid.plotOutput("bericht.beleid.beleid.plot.mobiliteit", plottitle = "Persberichten: per deelbeleid (Mobiliteit)")
                ),
                tabBox(
                  width = 6,
                  ...
                  bericht.beleid.beleid.plotOutput("bericht.beleid.beleid.plot.onderwijs", plottitle = "Persberichten: per deelbeleid (Onderwijs en Educatie)")
                ),
                tabBox(
                  width = 6,
                  ...
                  bericht.beleid.beleid.plotOutput("bericht.beleid.beleid.plot.provinciebestuur", plottitle = "Persberichten: per deelbeleid (Provinciebestuur)")
                ),
                tabBox(
                  width = 6,
                  ...
                  bericht.beleid.beleid.plotOutput("bericht.beleid.beleid.plot.ruimte", plottitle = "Persberichten: per deelbeleid (Ruimte)")
                ),
                tabBox(
                  width = 6,
                  ...
                  bericht.beleid.beleid.plotOutput("bericht.beleid.beleid.plot.vrijetijd", plottitle = "Persberichten: per deelbeleid (Vrije Tijd)")
                )
              )
            ),
        # Per Verzender -------------------------------------------------------
