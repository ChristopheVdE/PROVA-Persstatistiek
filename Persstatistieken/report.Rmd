...
kable(params$Persberichten.alg$dag.tabel(), caption = "Persberichten per dag")
```
...
kable(params$Persberichten.alg$week.tabel(), caption = "Persberichten per week")
```
...
##### 1.1.2.5. Persberichten per beleid {.tabset .tabset-fade}
###### Plot - aantal
...
kable(params$Persconferenties.alg$kwartaal.tabel(), caption = "Persconferenties per Beleid")
```
...
kable(params$Persconferenties.alg$maand.tabel(), caption = "Persconferenties per maand")
```
...
kable(params$Persconferenties.alg$dag.tabel(), caption = "Persconferenties per dag")
```
...
kable(params$Persconferenties.alg$week.tabel(), caption = "Persconferenties per week")
```
...
kable(params$Persconferenties.alg$beleid.tabel(), caption = "Persconferenties per Beleid")
```
